const Music4Mood = () => {
    return ( 
        <div className="project-description">
            ...
            <br/>
            The backend of the website is developed in <code>Flask</code> and <code>JavaScript</code> and uses the 
            <a href="https://developer.spotify.com/documentation/web-api">Spotify Web API</a> to suggest songs based on mood scores. 
            <br /><br/>
