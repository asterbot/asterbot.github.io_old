...
const Home = () => {
    ...
    const courses = {
        "2B": ["CS 241: Foundations of Sequential Programs", "CS 240: Data Structures and Data Management", "MATH 235: Linear Algebra 2 for Honours Mathematics", "PHYS 234: Quantum Physics 1", "FR 151: Basic French 1", "COMMST 225: Interviewing"],
        ...
        "1A": ["CS 145: Designing Functional Programs (Advanced)","MATH 135: Algebra I", "MATH 137: Calculus I", "PHYS 121: Mechanics", "SPCOM 223: Public Speaking"]    
    }
    ...
    return ( 
        <div className="home">
            ...
            {Object.entries(courses).map(([term,temp])=>{
                ...
                date={timelines[term]}
                icon={term.slice(0,2)==="WT" ? <WorkOutlineOutlinedIcon /> :  <SchoolOutlinedIcon />}
                >
